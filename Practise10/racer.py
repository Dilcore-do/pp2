...
SCREEN_HEIGHT = 600
SPEED = 5
SCORE = 0      # очки (уклонение от машин)
COINS = 0      # собранные монеты
...
class Enemy(pygame.sprite.Sprite):
    ...
    def move(self):
        ...
        # если вышел за экран — добавляем очко
...
class Coin(pygame.sprite.Sprite):
    ...
    def move(self):
        ...
        # если монета ушла вниз — просто обновляем позицию
        if self.rect.top > SCREEN_HEIGHT:
            self.reset_position()
